  ...
  return (
    <Layout title="Home page">
     ...
     <div className="container mx-auto w-11/12 mt-16">
       <h1 className="text-4xl font-bold">Work in your favorite place</h1>
       <div className="flex">
         <div className="image-width mr-6 mt-6">
           ...
           <h3 className="text-2xl font-semibold">Sourthen Beaches</h3>
         </div>
         <div className="image-width mr-6 mt-6">
           ...
           <h3 className="text-2xl font-semibold">Sourrounded By Nature</h3>
         </div>
         <div className="image-width mr-6 mt-6">
           ...
           <h3 className="text-2xl font-semibold">Unique Accomdation</h3>
         </div>
         <div className="image-width mr-6 mt-6">
